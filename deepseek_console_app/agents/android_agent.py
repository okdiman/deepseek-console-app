...
class AndroidAgent:
    ...
    async def _compress_history(self) -> None:
        ...
        summarize_prompt = "Сделай краткое саммари нашего предыдущего диалога. Сохрани ключевые факты, технологии и контекст обсуждаемой задачи."
        if self._session.summary:
            summarize_prompt += f" Вот текущее саммари, дополни его новой информацией:\n{self._session.summary}"
            
        summary_request = [
            {"role": "system", "content": "You are a specialized AI that summarizes context for an Android Agent without losing crucial technical details."},
        ]
